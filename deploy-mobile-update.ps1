...
$branch = "main"
$commitMessage = "更新移动端星空穹顶效果和社区页面优化"

# 要上传的文件
$filesToUpload = @(
    @{path="nexusorbital-mobile-replica.html"; localPath="e:\360MoveData\Users\Administrator\Documents\GitHub\nexusorbital-website\nexusorbital-mobile-replica.html"}
)

Write-Host "开始将移动端星空穹顶更新部署到GitHub..." -ForegroundColor Cyan
...
Write-Host "`n移动端星空穹顶更新已成功部署到GitHub!" -ForegroundColor Green
Write-Host "GitHub Actions将自动构建并部署网站。" -ForegroundColor Cyan
Write-Host "请等待几分钟，然后在手机端强制刷新页面查看更新。" -ForegroundColor White
